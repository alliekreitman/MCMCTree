...
#include "init/init_p21.h"  //change here
...
//    sprintf(fname1,"result/p21_%d_mu.txt",id); // change here
//    sprintf(fname2,"result/p21_%d_omega.txt",id); //change here
    sprintf(fname1,"result/p21_%d_%d_mu.txt",seed,id); // change here
    sprintf(fname2,"result/p21_%d_%d_omega.txt",seed,id); //change here
