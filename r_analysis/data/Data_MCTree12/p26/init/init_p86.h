...
//
#define DATADAYS 5
double datatime[DATADAYS+1]={-1,0,12,32,59,111};
int datanum[DATADAYS+1]={0,2,1,6,6,7};
...
BiNode *init()
{
    ...
    char *name;
    int   L;
    char *filename="fasta/p86sequence.fasta";  //
	...
	// data name
	char b0[datanum[1]][10]={"AY001961","AY001962"};
	char b1[datanum[2]][10]={"AY001971"};
	char b2[datanum[3]][10]={"AY001963","AY001964","AY001965","AY001966","AY001967","AY001974"};
	char b3[datanum[4]][10]={"AY001973","AY001976","AY001979","AY001980","AY001981","AY001982"};
    char b4[datanum[5]][10]={"AY001968","AY001969","AY001972","AY001970","AY001975","AY001977","AY001978"};
