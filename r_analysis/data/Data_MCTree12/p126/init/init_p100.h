...
//
#define DATADAYS 7
double datatime[DATADAYS+1]={-1,0,28,56,86,139,171,392};
int datanum[DATADAYS+1]={0,6,7,4,6,4,6,3};
...
BiNode *init()
{
    ...
    char *name;
    int   L;
    char *filename="fasta/p100sequence.fasta";  //
	...
	char b1[][10]={"AY001662","AY001673","AY001677","AY001678","AY001681","AY001682","AY001686"};
    ...
    char b6[][10]={"AY001661","AY001663","AY001667"};
