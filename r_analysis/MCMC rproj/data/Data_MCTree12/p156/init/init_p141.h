...
//
#define DATADAYS 6
double datatime[DATADAYS+1]={-10,0,6,41,83,102,171};
int datanum[DATADAYS+1]={0,2,7,5,6,8,8};
...
BiNode *init()
{
    ...
    char *name;
    int   L;
    char *filename="fasta/p141sequence.fasta";  //
	...
	// data name
	char b0[datanum[1]][10]={"AY001557","AY001559"};
	char b1[datanum[2]][10]={"AY001529","AY001530","AY001532","AY001535","AY001544","AY001556","AY001558"};
    char b2[datanum[3]][10]={"AY001527","AY001528","AY001531","AY001540","AY001542"};
	char b3[datanum[4]][10]={"AY001533","AY001539","AY001543","AY001546","AY001550","AY001560"};
