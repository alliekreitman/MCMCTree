...
int seqlength=-1;
int flagcount=0;
double drug_time=0.0;
#include "header/fasta.h"
#include "header/tree.h"
#include "init/init_p132.h"  //change here
...
void MCMC(){
    ...
    sprintf(fname1,"result/p132_%d_mu.txt",id); // change here
    sprintf(fname2,"result/p132_%d_omega.txt",id); //change here
